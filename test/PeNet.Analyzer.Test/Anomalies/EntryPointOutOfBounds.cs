...
{
    public class EntryPointOutOfBounds
    {
        [Theory]
        ...
        [InlineData(@".\Binaries\4df983666111ccfd9b4e9f5e304ae3ad9728f7d8c99ddc71bfa539eb342be13c", false)]
        [InlineData(@".\Binaries\56eb4985aeb09e28d0a5689ba9c6f791eb6ad31143d65bdb9858e90f718eb49b", false)]
        // Edge case: EP is directly on the last byte of he PE file --> PE file starts, but instantly crashes
        ...
        public void HasEntryPointOutOfBounds(string file, bool isValid)
        {
            var peFile = new PeFile(file);
            var anomaly = new Analyzer.Anomalies.EntryPointOutOfBounds(peFile);
