...
{
    public class InvalidImportDirectoryRva
    {
        [Theory]
        ...
        public void HasInvalidImportDirectoryRvaTest(string file, bool isValid)
        {
            var peFile = new PeFile(file);
            var anomaly = new Analyzer.Anomalies.InvalidImportDirectoryRva(peFile);
